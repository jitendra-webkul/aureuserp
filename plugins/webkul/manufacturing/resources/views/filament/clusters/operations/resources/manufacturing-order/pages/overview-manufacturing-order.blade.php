            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-white/5">
                    ...
                    <tfoot class="border-t border-gray-200 dark:border-white/5">
                        <tr>
                            <td colspan="7" class="px-4 py-4 text-right font-semibold text-gray-950 dark:text-white">
                            ...
                            <td class="px-4 py-4 text-right font-semibold text-gray-950 dark:text-white">${{ number_format($this->getUnitCost(), 2) }}</td>
                            <td class="px-4 py-4 text-right font-semibold text-gray-950 dark:text-white">$0.00</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
