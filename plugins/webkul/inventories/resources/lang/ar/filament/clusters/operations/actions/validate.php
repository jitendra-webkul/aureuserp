...
return [
    ...
    'notification' => [
        ...
        'warning' => [
            ...
            'cross-company' => [
                'title' => 'النقل بين الشركات غير مسموح',
                'body'  => 'لا يمكن للتحويل نقل المخزون مباشرة بين مواقع تابعة لشركات مختلفة (:source و :destination). التحويلات بين الشركات غير مدعومة بعد.',
            ],
        ],
    ],
];
